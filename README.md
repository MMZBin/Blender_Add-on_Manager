...
def register() -> None:
    ...
    # PropertyGroupManager.add(bpy.types.Scene, PropertyInfo(Your_PropertyGroup, Your_PropertyGroupType, "custom_key")) # By specifying a key, you can register multiple properties of the same type.
